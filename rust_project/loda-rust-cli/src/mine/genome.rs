...
impl Genome {
    ...
    pub fn mutate<R: Rng + ?Sized>(&mut self, rng: &mut R, context: &GenomeMutateContext) -> bool {
        let mutation_vec: Vec<(MutateGenome,usize)> = vec![
            ...
            (MutateGenome::SourceType, 50),
            (MutateGenome::DisableLoop, 5),
            ...
            (MutateGenome::IncrementTargetValueWhereTypeIsDirect, 2),
            (MutateGenome::DecrementTargetValueWhereTypeIsDirect, 2),
            (MutateGenome::ReplaceTargetWithHistogram, 50),
            (MutateGenome::ToggleEnabled, 100),
            (MutateGenome::SwapRows, 5),
