...
impl Genome {
    ...
    pub fn mutate_source_value_constant<R: Rng + ?Sized>(&mut self, rng: &mut R) -> bool {
        ...
        let mutation_vec: Vec<MutateValue> = vec![
            ...
            MutateValue::Assign(3),
            MutateValue::Assign(4),
