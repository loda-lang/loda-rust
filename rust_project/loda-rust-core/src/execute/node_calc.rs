...
impl NodeCalc {
    ...
    fn calc(&self, target: &BigInt, source: &BigInt) -> Result<BigInt, EvalError> {
        match self.instruction_id {
            ...
            // TODO: InstructionId::Power => Semantics::power(target, source),
            // TODO: InstructionId::GCD => Semantics::gcd(target, source),
            // TODO: InstructionId::Binomial => Semantics::binomial(target, source),
